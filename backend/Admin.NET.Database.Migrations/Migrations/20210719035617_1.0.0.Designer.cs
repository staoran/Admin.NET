...
namespace Admin.NET.Database.Migrations.Migrations
{
    ...
    [Migration("20210719035617_1.0.0")]
    partial class _100
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.OnlineUser", b =>
                {
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysCodeGen", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysCodeGenConfig", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysConfig", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysDictType", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysEmp", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("用户Id");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysEmpExtOrgPos", b =>
                {
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysEmpPos", b =>
                {
                    b.Property<long>("SysEmpId")
                        .HasColumnType("INTEGER")
                        .HasComment("员工Id");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysFile", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysLogAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysLogEx", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysLogOp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysLogVis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysMenu", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Pid = 142307070914651L,
                            Pids = "[0],[142307070914633],[142307070914651],",
                            Sort = 100,
                            Status = 0,
                            Type = 2,
                            Visible = "Y",
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysNotice", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysNoticeUser", b =>
                {
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysOauthUser", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysOrg", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysPos", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysRole", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysRoleDataScope", b =>
                {
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysRoleMenu", b =>
                {
                    b.Property<long>("SysRoleId")
                        .HasColumnType("INTEGER")
                        .HasComment("角色Id");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysTimer", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysUser", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("INTEGER")
                        .HasComment("Id主键");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysUserDataScope", b =>
                {
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysUserRole", b =>
                {
                    b.Property<long>("SysUserId")
                        .HasColumnType("INTEGER")
                        .HasComment("用户Id");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysDictData", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.SysDictType", "SysDictType")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysEmpExtOrgPos", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.SysEmp", "SysEmp")
                        .WithMany()
                        .HasForeignKey("SysEmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Furion.Extras.Admin.NET.SysOrg", "SysOrg")
                        .WithMany()
                        .HasForeignKey("SysOrgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Furion.Extras.Admin.NET.SysPos", "SysPos")
                        .WithMany()
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysRoleDataScope", b =>
                {
                    ...
                    b.HasOne("Furion.Extras.Admin.NET.SysRole", "SysRole")
                        .WithMany("SysRoleDataScopes")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysRoleMenu", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.SysMenu", "SysMenu")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysUserDataScope", b =>
                {
                    ...
                    b.HasOne("Furion.Extras.Admin.NET.SysUser", "SysUser")
                        .WithMany("SysUserDataScopes")
