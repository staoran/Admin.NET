...
import { getLoginUserAuthGet } from '/@/api_base/api/auth-api';
...
export const usePermissionStore = defineStore({
  ...
  actions: {
    ...
    async changePermissionCode() {
      const { permissions, menus } = await getLoginUserAuthGet();
      this.setPermCodeList(permissions);
      this.setFrontMenuList(menus);
    },
      ...
      switch (permissionMode) {
        ...
        case PermissionModeEnum.BACK:
          ...
          try {
            ...
            let menuList = cloneDeep(this.frontMenuList);
            menuList.forEach((menu) => {
              const component: string | null | undefined = menu.component;
